...
<body>
	<form id="cabinet_form" action="controller" method="get">
		<input type="hidden" name="command" value="acceptPayDamage" />
		<header>
			<nav>
		...
		<nav class="navBar">
			<ul class="sort_buttons">
				<li class=action_button><input type="submit" name = "acceptPayDamage" value="<fmt:message key='manager_jsp.label.accept_menu_page'/>"></li>
			</ul>
		</nav>
		</action>
		<fieldset>
